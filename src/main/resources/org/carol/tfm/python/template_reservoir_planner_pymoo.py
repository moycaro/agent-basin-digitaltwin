...
# Ejemplo de datos
#C1
inflow1 = %C1_INFLOW%              # Agua entrante en el ciclo actual en el pluvio SPE00156270
current_storage1 = %C1_CURRENT_VOL%     # Estado actual del embalse E065
max_capacity1 = %C1_MAX_CAPACITY%        # Capacidad máxima del embalse E065

#C2
inflow2 = %C2_INFLOW%              # Agua entrante en el ciclo actual en el pluvio SPE00156801
current_storage2 = %C2_CURRENT_VOL%     # Estado actual del embalse E063
max_capacity2 = %C2_MAX_CAPACITY%        # Capacidad máxima del embalse E063


#C3
inflow3 = %C3_INFLOW%               # Agua entrante en el ciclo actual en el pluvio SPE00156153
current_storage3 = %C3_CURRENT_VOL%     # Estado actual del embalse 2
max_capacity3 = %C3_MAX_CAPACITY%        # Capacidad máxima del embalse 2
threshold3 = %C3_THRESHOLD% # Umbral de seguridad para el caudal de agua en el agoro A137

#C4
threshold4 = %C4_THRESHOLD% # Umbral de seguridad para el caudal de agua en el agoro A115
